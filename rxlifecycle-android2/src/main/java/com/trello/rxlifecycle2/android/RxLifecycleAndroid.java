    ...
    private static final Function<ActivityEvent, ActivityEvent> ACTIVITY_LIFECYCLE =
        new Function<ActivityEvent, ActivityEvent>() {
            ...
            public ActivityEvent apply(ActivityEvent lastEvent) throws Exception {
                switch (lastEvent) {
                    case CREATE:
                        Log.w("TAG", " RxLifecycle RxLifecycleAndroid apply CREATE Return DESTORY:");
                    ...
                    case PAUSE:
                        Log.w("TAG", "RxLifecycle RxLifecycleAndroid apply PAUSE Return STOP:");
                        return ActivityEvent.STOP;
                    case STOP:
                        Log.w("TAG", "RxLifecycle RxLifecycleAndroid apply STOP Return DESTORY:");
                        return ActivityEvent.DESTROY;
                    case DESTROY:
