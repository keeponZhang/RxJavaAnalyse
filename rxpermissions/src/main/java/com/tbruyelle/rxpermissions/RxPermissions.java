...
public class RxPermissions {
    ...
    private Observable<?> pending(final String... permissions) {
        for (String p : permissions) {
            boolean b = mRxPermissionsFragment.containsByPermission(p);
            Log.e("TAG", "RxPermissions pending mRxPermissionsFragment.containsByPermission(p):"+b);
            if (!b) {
                Log.e("TAG", "RxPermissions pending  Observable.empty:");
                return Observable.empty();
            }
        }
        Log.e("TAG", "RxPermissions pending  Observable.just(null):");
